...
class DepartmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                'id_tahun'            => '1',
                'nama_department'         => 'Bendahara Umum',
                'kategori'            => 'Pengelolaan Keuangan',
                'deskripsi'           => 'Bertanggung jawab atas uang masuk dan keluar kepengurusan serta Transparansi dana, Memberikan pencerdasan kepada seluruh department mengenai berkas berkas keuangan yang diperlukan, Memantau dan mengatur cashflow KSM Psychorobotic agar sesuai dengan AD/ART, Menerima dan memberikan dana turunan kepada kepengurusan sebelum atau selanjutnya.',
                'ikon'                => 'fas fa-wallet',
                'urutan'              => '3',
                'status'              => 'aktif',
            ],
            ...
            [
                'id_tahun'            => '1',
                'nama_department'         => 'Pengajaran, Riset, dan Eksplorasi (PRE)',
