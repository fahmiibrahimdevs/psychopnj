...
const mqttClient = mqtt.connect(
    `mqtt://${MQTT_CONFIG.host}:${MQTT_CONFIG.port}`,
    {
        ...
        clientId: `mqtt_bridge_doorlock_${Math.random().toString(16).substr(2, 8)}`,
        clean: true,
...
// ===== ACCESS CHECK HANDLER (DOOR LOCK ONLY) =====
