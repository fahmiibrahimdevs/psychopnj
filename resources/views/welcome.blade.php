    ...
    <nav id="navbar" class="tw-hidden tw-bg-transparent tw-py-5 tw-px-4 lg:tw-block">
        <div class="tw-container tw-max-w-7xl tw-mx-auto tw-flex tw-justify-between tw-items-center">
            ...
            <ul class="tw-flex tw-text-sm tw-space-x-4 tw-list-none">
                <li><a href="http://192.168.18.104:8081"
                        class="tw-text-cyan-400">Home</a></li>
                <li><a href="http://192.168.18.104:8081/articles"
                        class="tw-text-gray-400">Article</a>
                </li>
                <li><a href="http://192.168.18.104:8081/project"
                        class="tw-text-gray-400">Project</a>
                </li>
                <li><a href="http://192.168.18.104:8081/course"
                        class="tw-text-gray-400">Course</a>
                </li>
                <li><a href="http://192.168.18.104:8081/religions"
                        class="tw-text-gray-400">Religions</a>
                </li>
                <li><a href="http://192.168.18.104:8081/lectures"
                        class="tw-text-gray-400">Lectures</a>
                </li>
            </ul>
        </div>
    </nav>
            ...
            <div class="tw-flex-grow tw-container tw-max-w-7xl tw-mx-auto">
                <div class="tw-grid tw-grid-cols-1 tw-px-4 tw-gap-10 lg:tw-grid-cols-3 lg:tw-px-4">
                    <div class="tw-col-span-2">
                        ...
                        <div class="tw-mt-10 tw-flex">
                            <a href="http://192.168.18.104:8081/articles"
                ...
                <div class="tw-mt-16 tw-px-4 md:tw-px-4 lg:tw-mt-20 lg:tw-px-4">
                    ...
                    <div class="tw-flex tw-items-start tw-mt-8">
                        <img src="http://192.168.18.104:8081/icons/Intek.png" class="tw-w-14 lg:tw-w-20 tw-rounded-full tw-mr-5 mt-[-10px]"
                            alt="">
                        <div>
                ...
                <div class="tw-mt-16 tw-px-4 md:tw-px-4 lg:tw-mt-20 lg:tw-px-4">
                    ...
                    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-y-10 lg:tw-grid-cols-6 lg:tw-gap-x-20 tw-mt-7">
                        <div>
                            ...
                            <ul id="tech-stack" class="tw-space-y-5 tw-p-0">
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/HTML5.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>HTML5</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/CSS3.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>CSS 3</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/JavaScript.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                ...
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Python.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>Python</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Dart.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>Dart</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Cplusplus.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>C++ Arduino</span>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul id="tech-stack" class="tw-space-y-5 tw-p-0">
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/MySQL.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>MySQL</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/MariaDB.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>MariaDB</span>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul id="tech-stack" class="tw-space-y-5 tw-p-0">
                                ...
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/NodeJS.svg" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>NodeJS</span>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul id="tech-stack" class="tw-space-y-5 tw-p-0">
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Laravel.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>Laravel</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Flutter.png" class="tw-rounded-lg tw-w-5 tw-mr-5"
                                        alt="">
                                    <span>Flutter</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/TailwindCSS.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>TailwindCSS</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Bootstrap.png" class="tw-rounded-lg tw-w-7 tw-mr-3"
                                        alt="">
                                    <span>Bootstrap</span>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul id="tech-stack" class="tw-space-y-5 tw-p-0">
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Arduino.png" class="tw-rounded-lg tw-w-5 tw-mr-5"
                                        alt="">
                                    <span>Arduino</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/ESP8266.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>ESP8266</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/ESP32.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>ESP32</span>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul id="tech-stack" class="tw-space-y-5 tw-p-0">
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/jQuery.png" class="tw-rounded-lg tw-w-5 tw-mr-5"
                                        alt="">
                                    <span>jQuery</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Github.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>GitHub</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/Postman.svg" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>Postman</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/EasyEDA.jpg" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>EasyEDA</span>
                                </li>
                                <li class="tw-flex tw-items-center">
                                    <img src="http://192.168.18.104:8081/icons/MQTT.png" class="tw-rounded-lg tw-w-6 tw-mr-4"
                                        alt="">
                                    <span>MQTT</span>
                                </li>
                            </ul>
                ...
                <div class="tw-mt-16 tw-px-4 md:tw-px-4 lg:tw-mt-20 lg:tw-px-4">
                    ...
                    <div class="tw-flex tw-items-start tw-mt-10">
                        <img src="http://192.168.18.104:8081/icons/Udemy.jpg"
                        ...
                        <div class="tw-ml-4 tw-mt-1">
                            <h4 class="tw-text-base lg:tw-text-lg">NodeJS Course PZN <a
                                    href="http://192.168.18.104:8081/images/NodeJS_Course_Udemy.jpg" target="_BLANK"><i
                    ...
                    <div class="tw-flex tw-items-start tw-mt-7">
                        ...
                        <div class="tw-ml-4 tw-mt-3">
                            <h4 class="tw-text-base lg:tw-text-lg">Divisi Mekatronika - Magang <a
                                    href="http://192.168.18.104:8081/images/Sertifikat_PT_Solusi_Intek.pdf" target="_BLANK"><i
                                        class="fas fa-external-link tw-ml-3 tw-text-sm lg:tw-text-base tw-text-gray-400"></i></a>
                            </h4>
                    ...
                    <div class="tw-flex tw-items-start tw-mt-7">
                        <img src="http://192.168.18.104:8081/icons/SMKN5.png"
                        ...
                        <div class="tw-ml-4 tw-mt-0">
                            <h4 class="tw-text-base lg:tw-text-lg">SMKN 5 JAKARTA <a
                                    href="http://192.168.18.104:8081/images/Sertifikat_SMKN5JKT.pdf" target="_BLANK"><i
                                        class="fas fa-external-link tw-ml-3 tw-text-sm lg:tw-text-base tw-text-gray-400"></i></a>
                            </h4>
